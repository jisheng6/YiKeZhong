...
public class ReDianAdapter extends XRecyclerView.Adapter<ReDianAdapter.IViewholder>{
    private Context context;
    private List<ReDianBean.DataBean>list;

    public ReDianAdapter(Context context) {
        this.context = context;
    }
    public void addData(ReDianBean bean){
        if(list == null){
            list = new ArrayList<>();
        }
    ...
    public IViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.layout_redian, null);
