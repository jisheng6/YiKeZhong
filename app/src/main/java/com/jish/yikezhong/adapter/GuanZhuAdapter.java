...
public class GuanZhuAdapter extends XRecyclerView.Adapter<GuanZhuAdapter.IViewholder>{
    ...
    public void addData(GuanZhuBean bean){
        if(list == null){
            list = new ArrayList<>();
        }
    ...
    public IViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.layout_guanzhu, null);
    ...
    public void onBindViewHolder(final IViewholder holder, final int position) {
        ...
        holder.title.setText(list.get(position).getUser().getNickname());
        holder.time.setText(list.get(position).getCreateTime());
        holder.name.setText(list.get(position).getWorkDesc());
        holder.image.setUp(list.get(position).getVideoUrl(), JCVideoPlayerStandard.SCREEN_LAYOUT_NORMAL,"");
